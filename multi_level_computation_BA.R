...
sbm_multi_level_scores_table <- function(block_sizes1=c(2,2,2,2), block_sizes2=rep(25, times=8), 
    ...
    sample_graph <- function(lambda){
        ...
        save(g, membership_lower_level, membership_upper_level, file="debug_g.RData")
        scores_lower <- scoring_functions(g, membership_lower_level, type="global")
        scores_upper <- scoring_functions(g, membership_upper_level, type="global")
